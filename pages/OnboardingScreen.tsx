...
const styles = StyleSheet.create({
  ...
  image: {
    ...
    height: '40%',
    resizeMode: 'contain',
    marginBottom: 100, // הורדנו את התמונה מעט כדי שהכפתור יוכל לשבת כמו שצריך
  },
  title: {
    fontSize: 28,
    fontWeight: 'bold',
  ...
  text: {
    ...
    textAlign: 'center',
    marginHorizontal: 30,
    marginBottom: 10, // הפחתנו מעט את המרווח לפני התמונה
  },
  button: {
    ...
    borderRadius: 30,
    position: 'absolute', // שימוש ב'position: absolute' כדי שהכפתור לא יהיה רחוק מדי
    bottom: 70, // הכפתור לא יהיה נמוך מדי במסך
  },
  buttonText: {
    color: '#fff',
    fontSize: 18,
